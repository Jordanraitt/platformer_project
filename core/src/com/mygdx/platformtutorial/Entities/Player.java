...
public class Player extends Entity {
    ...
    public TextureRegion getFrame(float deltaTime) {
        ...
        if (((Gdx.input.isKeyPressed(Keys.LEFT)) || (Gdx.input.isKeyPressed(Keys.A) && grounded) || !runningRight) && !region.isFlipX()){
            region.flip(true, false);
            runningRight = false;
        }
        else if (((Gdx.input.isKeyPressed(Keys.RIGHT)) || (Gdx.input.isKeyPressed(Keys.D) && grounded) || runningRight)&& region.isFlipX()) {
            region.flip( true, false);
            runningRight = true;
        }
